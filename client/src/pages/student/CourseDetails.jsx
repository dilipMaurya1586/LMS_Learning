...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    items-start justify-between md:px-36 px-8 md:placeholder-teal-300 pt-20 text-left">
                    ...
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className="flex items-start gap-2 py-1">
                          <img src={assets.play_icon} alt="play_icon" className="w-4 h-4 mt-1 cursor-pointer" />
        ...
        min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <button className="md:mt-6 mt-4 w-full py-3 rounded text-center bg-blue-600 text-white font-medium">
